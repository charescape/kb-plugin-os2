...
<div class="panel">
    ...
    <?= $this->form->label(t('Aliyun Access Key ID'), 'aliyun_oss_accesskey_id') ?>
    <?= $this->form->password('aliyun_oss_accesskey_id', $values) ?>

    <?= $this->form->label(t('Aliyun Access Key Secret'), 'aliyun_oss_accesskey_secret') ?>
    <?= $this->form->password('aliyun_oss_accesskey_secret', $values) ?>
